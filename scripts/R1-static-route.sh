...
sudo ipfw add 3000 pipe 1 ip from 192.168.253.0/24 to 192.168.254.0/24 in
sudo ipfw add 3100 pipe 2 ip from 192.168.253.0/24 to 192.168.254.0/24 out
sudo ipfw add 4000 pipe 3 ip from 192.168.254.0/24 to 192.168.253.0/24 in
sudo ipfw add 4100 pipe 4 ip from 192.168.254.0/24 to 192.168.253.0/24 out
